...
def perfil(request):
    ...
    if request.method == "POST":
        ...
        # Trazer todos os usuários que tem o username digitado pelo usuário com excessão dele mesmo
        ...
        # Trazer todos os usuários que tem o email digitado pelo usuário com excessão dele mesmo
